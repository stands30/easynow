                              ...
                              <div class="col-md-6 col-sm-6 mob-date text-right">
                                <div class="breadcrumb-date">
                                  ...
                                  <div class="page-toolbar">
                                    <div id="daterangepicker-custom-range" class="pull-right tooltips btn btn-sm btn-range-divider" data-container="body" data-placement="bottom" data-original-title="Change Campaign List Date Range" data-daterangevaluestart="" data-daterangevalueend="">
                        ...
                        <!-- END PAGE HEADER-->
                                ...
                                <div class="portlet-title">
                                    <div class="caption font-dark">
                                        ...
                                        <span class="list-title-caption caption-subject bold "><i class="fas fa-bullhorn pie-color"></i><?php  echo $title; ?></span>
