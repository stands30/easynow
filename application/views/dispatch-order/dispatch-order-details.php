                                          ...
                                          <tbody>
                                            ...
                                            <tr>
                                              ...
                                              <td >
                                                ...
                                                <a href="javascript:;" id="dor_apprvl_status" name="dor_apprvl_status" class="dor_apprvl_status dispatch-apprvl-status-editable" data-type="select2" data-pk="1" data-placement="top" data-placeholder="Please Select Approval Status" data-original-title="Select Approval Status" data-custom_select2_id="<?php if(isset($dispatch_order->dor_apprvl_status)) echo $dispatch_order->dor_apprvl_status; ?>" data-custom_select2_name="<?php if(isset($dispatch_order->dor_apprvl_status_value)) echo $dispatch_order->dor_apprvl_status_value; ?>"  data-gnp-grp="dor_apprvl_status"><?php if(isset($dispatch_order->dor_apprvl_status)) echo $dispatch_order->dor_apprvl_status_value; ?> </a>
                                              </td>
