                  ...
                  <form role="form" id="custom_module_form" class="col-md-12 form_edit">
                    ...
                    <div class="row row-qout">
                      ...
                      <div class=" col-md-2 col-xs-6 label-qout">
                        <label class="control-label amt-disc">Sub Total <?php print_r($dispatch_order); ?></label>
                      </div>
                    ...
                    <div class="row row-qout">
                      <div class="col-md-8"></div>
                      <div class=" col-md-2 col-xs-6 label-qout">
                        <label class="control-label amt-disc form_gst_percent_span">Tax <?php echo ($product_tax != '1') ? '('.$tax_percent.' %)':''; ?><?php echo isset($dispatch_order->dor_tax_format) ? $dispatch_order->dor_tax_format:'0.00'; ?></label>
                      </div>
                      <div class="col-md-2 col-xs-6 text-right">
