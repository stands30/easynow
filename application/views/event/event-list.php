              ...
              <div class="col-md-6 col-sm-6 mob-date text-right">
                <div class="breadcrumb-date">
                  ...
                  <div class="page-toolbar">
                    <div id="daterangepicker-custom-range" class="pull-right tooltips btn btn-sm btn-range-divider" data-container="body" data-placement="bottom" data-original-title="Change Event List Date Range" data-daterangevaluestart="" data-daterangevalueend="">
          ...
          <div class="portlet light bordered">
            <div class="portlet-title">
              <div class="caption font-dark">
                ...
                <span class="list-title-caption caption-subject bold "><i class="fas fa-location-arrow icon-event"></i> <?php  echo $title; ?></span>
                <div class="btn-group">
                  <?php if($add_access) { ?>
        ...
        var customDataTableColumns = [
           ...
           {   'data'  : 'evt_encrypt_id' ,
             'render': function(data, type, row, meta)
             {
              ...
              <?php if($edit_access) { ?>
                link += `<a href="`+baseUrl+`event-edit-`+row.evt_encrypt_id+`" title="Edit Events" class="datatable-links edit">
                     <i class="fa fa-edit" aria-hidden="true"></i></a>&nbsp;`;
              <?php }?>

              <?php if($delete_access) { ?>
                link += `<a onclick="deleteEvent('`+row.evt_id+`')" title="Delete Events" class="datatable-links delete">
