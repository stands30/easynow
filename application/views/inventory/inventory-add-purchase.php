                    ...
                    <div class="row">
                      ...
                      <div class="col-md-3">
                        <div class="form-group  form-md-line-input form-md-floating-label">
                          ...
                          <div class="input-icon">
                            <input type="text" id="piv_date" name="piv_date" class="form-control inv_date date date-picker" required="" data-msg="Please Select Date" data-minDate="2019-04-30">
                    ...
                    <div class="row mb-40">
                      ...
                      <div class="col-md-6">
                        <div class="form-group form-md-line-input form-md-floating-label rep-float-label">
                          ...
                          <div class="input-icon">    
                              <select type="select" name="piv_managed_by" id="piv_managed_by" class="form-control form-repeater-data" data-msg="Please Select Received By">
                                <option class="blank_option"></option>
                              </select> 
