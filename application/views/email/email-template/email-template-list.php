          ...
          <div class="portlet light bordered">
            <div class="portlet-title">
              <div class="caption font-dark">
                ...
                <span class="caption-subject bold"><i class="fa fa-envelope title"></i>Email Template List
                </span> &nbsp;
                <div class="btn-group">
        ...
        function getEmailTempList()
        {
          ...
          var customDataTableColumns = [
              ...
              {   'data'  : 'emt_id' ,
                'render': function(data, type, row, meta)
                {
                    link = `<a href="`+baseUrl+`email-template-edit-`+row.emt_id_encrypt+`" title="Edit Email Template " class="datatable-links edit">
