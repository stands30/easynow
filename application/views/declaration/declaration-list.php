                          ...
                          <div class="col-md-6 col-sm-6 mob-date text-right">
                            <div class="breadcrumb-date">
                              ...
                              <div class="page-toolbar">
                                <div id="daterangepicker-custom-range" class="pull-right tooltips btn btn-sm btn-range-divider" data-container="body" data-placement="bottom" data-original-title="Change Declaration List Date Range" data-daterangevaluestart="" data-daterangevalueend="">
                    ...
                    <!-- END PAGE HEADER-->
                            ...
                            <div class="portlet-title">
                                <div class="caption font-dark">
                                    ...
                                    <span class="list-title-caption caption-subject bold "><i class="fas fa-portrait dark-green"></i><?php  echo $title; ?></span>
                            ...
                            <div class="portlet-body">
                                <table class="table table-striped table-bordered table-quot table-list" id="module-list">
                                    <thead>
                                        <tr>
                                            <th>Mission</th>
                                            <th>Vision</th>
